      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white/80 backdrop-blur-xl border border-gray-100 rounded-3xl shadow-soft p-6 mb-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <FontAwesomeIcon icon={faShoppingCart} className="text-primary-600 w-6 h-6" />
              ...
              {cart.length > 0 ? (
                <div className="space-y-6">
                  {cart.map((e) => (
                    <div key={e.id} className="flex items-center gap-4 p-4 bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-100 shadow-soft hover:shadow-medium transition-all duration-300">
                      {/* Product Image */}
                      <Link to={`/product-details/${e.id}`} className="flex-shrink-0">
                        <img 
                          src={e.image} 
                          alt={e.title}
                          className="w-20 h-20 object-contain rounded-xl bg-gray-50 p-2 hover:scale-105 transition-transform duration-200"
                        />
                      </Link>
                      ...
                      <div className="flex items-center gap-3">
                        <div className="flex items-center bg-gray-50 rounded-xl p-1">
                          ...
                          >
                            <FontAwesomeIcon icon={faArrowDown} className="w-3 h-3 text-gray-600" />
                          </button>
                          ...
                          <button
                            ...
                            className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-gray-200 transition-colors duration-200"
                          >
                            <FontAwesomeIcon icon={faArrowUp} className="w-3 h-3 text-gray-600" />
                          </button>
                        </div>
                      </div>
                      ...
                      {/* Remove Button */}
                      <button
                        onClick={() => dispatch({ type: "RemoveFromCart", product: e })}
                        className="flex-shrink-0 w-10 h-10 flex items-center justify-center rounded-full bg-red-50 text-red-500 hover:bg-red-100 transition-all duration-200 hover:scale-110"
                ...
                <div className="text-center py-16">
                  <FontAwesomeIcon icon={faShoppingCart} className="w-16 h-16 text-gray-300 mb-4" />
                  <p className="text-lg font-semibold text-gray-400 mb-2">Your cart is empty.</p>
                  <Link 
                    to="/shop" 
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/80 backdrop-blur-xl border border-gray-100 rounded-3xl shadow-soft p-6 sticky top-8">
              <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <FontAwesomeIcon icon={faCreditCard} className="text-primary-600 w-5 h-5" />
                Cart Total
              </h3>
              ...
              <div className="mb-6 p-4 bg-gray-50 rounded-2xl">
                <div className="flex items-center gap-2 mb-3">
                  <FontAwesomeIcon icon={faTag} className="text-secondary-600 w-4 h-4" />
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-600 flex items-center gap-2">
                    <FontAwesomeIcon icon={faTruck} className="w-4 h-4 text-green-500" />
                    Shipping:
                  </span>
                ...
                <div className="border-t border-gray-200 pt-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-2xl font-bold text-primary-600">${subtotal}</span>
                  </div>
                </div>
              </div>
