        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-8">
              ...
              <div className="text-center p-6 bg-white/60 backdrop-blur-sm rounded-2xl border border-gray-100 shadow-soft hover:shadow-medium transition-all duration-300 hover:-translate-y-1">
                <FontAwesomeIcon
                  icon={faShoppingBag}
                  className="w-8 h-8 text-secondary-600 mb-3"
                />
          ...
          <div className="relative">
            <div className="relative group">
              <div className="absolute -inset-2 sm:-inset-4 bg-gradient-to-r from-primary-600 to-secondary-600 rounded-3xl blur opacity-25 group-hover:opacity-40 transition duration-1000 group-hover:duration-200"></div>
            ...
            {/* Floating elements */}
            <div className="absolute -top-2 -right-2 sm:-top-4 sm:-right-4 bg-white/90 backdrop-blur-sm rounded-2xl p-2 sm:p-4 shadow-large">
            ...
            <div className="absolute -bottom-2 -left-2 sm:-bottom-4 sm:-left-4 bg-gradient-to-r from-primary-600 to-secondary-600 text-white rounded-2xl p-2 sm:p-4 shadow-large">
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-8">
          <div className="text-center p-8 bg-white/60 backdrop-blur-sm rounded-3xl border border-gray-100 shadow-soft hover:shadow-large transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-gray-600 leading-relaxed">
              Every product in our marketplace undergoes rigorous quality checks
          ...
          <div className="text-center p-8 bg-white/60 backdrop-blur-sm rounded-3xl border border-gray-100 shadow-soft hover:shadow-large transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-gray-600 leading-relaxed">
              Serving millions of customers across South Asia with a network of
          ...
          <div className="text-center p-8 bg-white/60 backdrop-blur-sm rounded-3xl border border-gray-100 shadow-soft hover:shadow-large transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-gray-600 leading-relaxed">
              Our commitment to exceptional customer service and satisfaction
